...
import { idlFactory } from './cycles-burner-canister.did.js';
export { idlFactory } from './cycles-burner-canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CYCLES-BURNER-CANISTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cycles-burner-canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cycles-burner-canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cycles-burner-canister.did.js")._SERVICE>}
 */
export const cycles-burner-canister = createActor(canisterId);
